...
FocusScope {
    ...
    Column {
        ...
        width: AppStyleSheet.limitedWidth(2, alertInstance.width, 0.9)
        ...
        Text {
            ...
            color: "black"
            font.bold: true
            font.pixelSize: AppStyleSheet.height(0.14)
        ...
        Text {
            ...
            color: "black"
            font.pixelSize: AppStyleSheet.height(0.10)
            wrapMode: Text.WordWrap
            horizontalAlignment: Text.AlignHCenter
        ...
        Item {
            width: column.width
            height: AppStyleSheet.height(0.08)
        }
        ...
        RowLayout {
            width: column.width
            spacing: AppStyleSheet.width(0.08)
